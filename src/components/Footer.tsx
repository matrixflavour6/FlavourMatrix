...
import { FlaskConical, Github, Shield, Compass } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 pb-8 border-b border-zinc-200">
          ...
          <div className="md:col-span-6 flex flex-col gap-4">
            ...
            <p className="text-xs text-zinc-500 leading-relaxed max-w-sm">
              An open-access, completely free scientific archive merging chemical thresholds with practical culinary applications. Learn the biochemical volatility and synergy principles behind fine food with absolute lab precision.
            </p>
          </div>
          ...
          {/* Core Metrics (3 cols) */}
          <div className="md:col-span-3">
            <span className="block font-mono text-[9px] font-bold text-zinc-400 uppercase tracking-widest mb-4">KNOWLEDGE METRICS</span>
            <ul className="space-y-2 text-xs font-mono text-zinc-500">
              <li className="flex justify-between">
                <span>Active Specimens:</span>
                <strong className="text-zinc-800">12 Probed</strong>
              </li>
              <li className="flex justify-between">
                <span>Volatility Catalog:</span>
                <strong className="text-zinc-800">80+ Species</strong>
              </li>
              <li className="flex justify-between">
                <span>Archive License:</span>
                <strong className="text-zinc-800">Creative Commons</strong>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px] font-mono text-zinc-400 uppercase">
          <div className="flex items-center gap-1.5">
            ...
            <span>&copy; {new Date().getFullYear()} Flavour Matrix. Public domain molecular culinary research.</span>
          </div>
          
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1"><Shield className="h-3 w-3" /> local cache browser preservation</span>
